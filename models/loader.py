...
class RobustPersonReIDPredictor:
...
def init_reid(checkpoint_path: str | Path, device: str | None = None) -> RobustPersonReIDPredictor:
    return RobustPersonReIDPredictor(checkpoint_path, device)
