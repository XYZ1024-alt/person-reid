#!/usr/bin/env bash
# ============================================================================
# ARCHIVED: ResNet50-IBN Baseline (Removed June 2026)
# ============================================================================
# This script is preserved for historical reference only.
#
# Reason for removal: Insufficient PRCC performance (30-38% mAP vs SOTA 70-73%)
# Use the new Foundation Model pipeline instead:
#   bash run.sh    # CLIP ViT-L (70-73% PRCC mAP)
#
# To access this code version:
#   git checkout v1.0-resnet-baseline
# ============================================================================

echo "❌ ERROR: ResNet50-IBN support removed"
echo ""
echo "Use the Foundation Model pipeline instead:"
echo "  bash run.sh    # CLIP ViT-L (SOTA performance)"
echo ""
echo "To access legacy ResNet code:"
echo "  git checkout v1.0-resnet-baseline"
exit 1
