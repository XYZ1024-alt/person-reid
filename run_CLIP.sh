...
# CLIP全程训练流程 - 方案2：Market和PRCC双优
# 预期效果：Market mAP 88-90%, PRCC mAP 70-73%
# 总训练时间：约48小时
...
if [[ "$START_STAGE" -le 2 && "$STOP_STAGE" -ge 2 ]]; then
  ...
  echo "目标：Market mAP 88-90%, PRCC mAP 40-45%"
  echo "训练时长：18-22小时"
  echo "============================================================================"
